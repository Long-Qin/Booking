...
class UploadStay extends React.Component {
    ...
    render() {
        return (
            ...
            >
                <Form.Item name="name" label="Name" rules={[{ requires: true }]}>
                    <Input />
                </Form.Item>

                <Form.Item name="address" label="Address" rules={[{ requires: true }]}>
                    <Input />
                </Form.Item>
                ...
                name="guest_number"
                label="Guest Number"
                rules={[{ requires: true, type: "number", min: 1 }]}
                >
                    <InputNumber />
                </Form.Item>
                <Form.Item name="picture" label="Picture" rules={[{ requires: true }]}>
                    <input 
                    type="file"
